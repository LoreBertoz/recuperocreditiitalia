...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'agency');
  CREATE TYPE "public"."enum_agencies_sponsor_tier" AS ENUM('base', 'premium', 'top');
  CREATE TYPE "public"."enum_agencies_subscription_status" AS ENUM('pending', 'active', 'suspended');
  CREATE TYPE "public"."enum_locations_type" AS ENUM('regione', 'provincia', 'citta');
  CREATE TYPE "public"."enum_blog_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__blog_posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_lead_requests_type" AS ENUM('partner', 'contact');
  CREATE TYPE "public"."enum_lead_requests_requested_tier" AS ENUM('base', 'premium', 'top');
  CREATE TYPE "public"."enum_lead_requests_status" AS ENUM('new', 'contacted', 'closed');
  ...
  CREATE TABLE "users" (
  	...
  	"name" varchar,
  	"role" "enum_users_role" DEFAULT 'agency' NOT NULL,
  	"agency_id" integer,
  ...
  CREATE TABLE "agencies" (
  	...
  	"headquarters_province" varchar,
  	"headquarters_postal_code" varchar,
  	"headquarters_lat" numeric NOT NULL,
  	"headquarters_lng" numeric NOT NULL,
  	"contact_phone" varchar,
  	"contact_email" varchar,
  	"website" varchar,
  	"whatsapp" varchar,
  	"sponsor_tier" "enum_agencies_sponsor_tier" DEFAULT 'base' NOT NULL,
  	"subscription_status" "enum_agencies_subscription_status" DEFAULT 'pending' NOT NULL,
  ...
  CREATE TABLE "lead_requests" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"type" "enum_lead_requests_type" DEFAULT 'contact' NOT NULL,
  	"name" varchar NOT NULL,
  	"company" varchar,
  	"email" varchar NOT NULL,
  	"phone" varchar,
  	"requested_tier" "enum_lead_requests_requested_tier",
  	"message" varchar,
  	"privacy_consent" boolean DEFAULT false NOT NULL,
  	"status" "enum_lead_requests_status" DEFAULT 'new',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "agencies_rels" ADD CONSTRAINT "agencies_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."agencies"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "agencies_rels" ADD CONSTRAINT "agencies_rels_services_fk" FOREIGN KEY ("services_id") REFERENCES "public"."services"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "agencies_rels" ADD CONSTRAINT "agencies_rels_locations_fk" FOREIGN KEY ("locations_id") REFERENCES "public"."locations"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "agencies_sponsor_tier_idx" ON "agencies" USING btree ("sponsor_tier");
  CREATE INDEX "agencies_subscription_status_idx" ON "agencies" USING btree ("subscription_status");
  ...
  CREATE INDEX "agencies_rels_order_idx" ON "agencies_rels" USING btree ("order");
  CREATE INDEX "agencies_rels_parent_idx" ON "agencies_rels" USING btree ("parent_id");
  CREATE INDEX "agencies_rels_path_idx" ON "agencies_rels" USING btree ("path");
  CREATE INDEX "agencies_rels_services_id_idx" ON "agencies_rels" USING btree ("services_id");
  CREATE INDEX "agencies_rels_locations_id_idx" ON "agencies_rels" USING btree ("locations_id");
  ...
  CREATE UNIQUE INDEX "type_slug_idx" ON "locations" USING btree ("type","slug");
  ...
  CREATE INDEX "lead_requests_updated_at_idx" ON "lead_requests" USING btree ("updated_at");
  CREATE INDEX "lead_requests_created_at_idx" ON "lead_requests" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_lead_requests_id_idx" ON "payload_locked_documents_rels" USING btree ("lead_requests_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "agencies_rels" CASCADE;
  ...
  DROP TYPE "public"."enum_agencies_sponsor_tier";
  DROP TYPE "public"."enum_agencies_subscription_status";
  DROP TYPE "public"."enum_locations_type";
  DROP TYPE "public"."enum_blog_posts_status";
  DROP TYPE "public"."enum__blog_posts_v_version_status";
  DROP TYPE "public"."enum_lead_requests_type";
  DROP TYPE "public"."enum_lead_requests_requested_tier";
